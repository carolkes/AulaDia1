...
{
    public partial class BandoDeDadosInnerJoinContext : DbContext
    {
        public BandoDeDadosInnerJoinContext()
        {
        }

        public BandoDeDadosInnerJoinContext(DbContextOptions<BandoDeDadosInnerJoinContext> options)
            : base(options)
        {
        }
